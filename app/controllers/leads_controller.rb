class LeadsController < ApplicationController
  ...
  private
    ...
    def lead_params
      params.require(:lead).permit(:company_name, :link, :position_title, :city, :state, :contact_person, :contact_email, :apply_via, :deadline, :found_by, :applied, :pending, :offer, :wage)
    end
end
